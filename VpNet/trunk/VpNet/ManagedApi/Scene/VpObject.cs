...
namespace VpNet
{
    ...
    {
        internal VpObject(int id, int type, DateTime time, int owner, TVector3 position, TVector3 rotation, float angle, string action, string description, int objectType, string model)
