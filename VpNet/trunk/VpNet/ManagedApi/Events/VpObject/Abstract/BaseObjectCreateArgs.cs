...
{
    public abstract class BaseObjectCreateArgs<TAvatar, TVpObject, TVector3> : EventArgs, IObjectCreateArgs<TAvatar, TVpObject,TVector3> where TVector3 : class, IVector3, new()
