...
namespace VpNet.Abstract
{
    ...
    [Serializable]
    public abstract class BaseObjectChangeArgs<TAvatar,TVpObject,TVector3> : EventArgs, IObjectChangeArgs<TAvatar, TVpObject, TVector3> where TVector3 : class, IVector3,new()
