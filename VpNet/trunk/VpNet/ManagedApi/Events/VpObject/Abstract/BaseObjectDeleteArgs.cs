...
{
    [Serializable]
    public abstract class BaseObjectDeleteArgs<TAvatar, TVpObject, TVector3> : EventArgs, IObjectDeleteArgs<TAvatar, TVpObject, TVector3> where TVector3 : class, IVector3, new()
