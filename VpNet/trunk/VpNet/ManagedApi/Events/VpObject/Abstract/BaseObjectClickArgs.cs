...
{
    [Serializable]
    public abstract class BaseObjectClickArgs<TAvatar, TVpObject, TVector3> : EventArgs, IObjectClickArgs<TAvatar, TVpObject,TVector3> where TVector3 : class, IVector3, new()
